      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Digital Bond</h2>
            <h2 className="text-4xl my-5 font-bold tracking-tight text-white sm:text-4xl">Work with us</h2>
            ...
            <div className="text-center mt-20">
                <Link to="/form" className="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">Apply Now</Link>
            </div>
            </div>
        </div>
    )
